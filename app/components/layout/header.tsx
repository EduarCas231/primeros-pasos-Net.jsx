...
function Logo() {
  return (
    <Link href="/" className="group flex items-center gap-2 text-lg font-semibold tracking-tight text-zinc-900 dark:text-white">
      <svg className="h-10 w-10 transition-transform group-hover:scale-105" viewBox="0 0 64 64" fill="none">
